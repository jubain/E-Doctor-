...
import { StyleSheet, Text, View, Platform, Dimensions, Linking } from 'react-native';
    ...
    <NavigationContainer theme={myTheme} ref={navigationRef}>
      <Stack.Navigator initialRouteName="Loading"
        ...
        <Stack.Screen name="Chat" component={Chat}
          options={({ route }) => ({
            title: route.params.user.photoURL === 'patient' ? route.params.doctor : route.params.patientName,
            headerLeft: () => (
              <Button
                title="Back"
                type="clear"
